...
1. **Data tab**
   - Start with a synthetic profile for smoke tests.
...
- Add export actions for metrics, residuals, and predictions across all five
  approaches.
- Expand water-balance residuals beyond the current local profiles as calibrated
  hydrologic-process assumptions become available.
