...
INCLUDEPATH += \
    ...
    . Utilities Hydro Hydro/dataset Hydro/models Hydro/physics
...
!exists($$GISTOHQ_PINN_WINDOW) {
    error("Failed to generate GIStoOHQ PINN-enabled HydroPINN window source.")
}
